...
To create your own version of documentation to view a final rendering you'll need to follow these steps:
	1. Create a github repository named pecan-documentation
	2. Create a GITHUB token and enter it as a variable within TRAVIS
	3. Create a branch from your Fork of PEcAn that starts with the pattern "release/"
	4. Make your changes to documentation, push them to your fork and let TRAVIS build your documentation.

These procedures assume you have an github account, you forked pecan, you have cloned pecan locally, and have a TRAVIS account. 
	1. Create a repository under your github account with the name "pecan-documentation". Clear it of any files. Set up the repository with Github Pages under the settings for that repository.
	...
	3. Create a TRAVIS environment variable called `GITHUB_PAT` and save the access token you made has a secret variable.

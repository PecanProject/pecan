...
1. A user section that is split into three ways into a basic user's guide, advanced web interface guide, and an advanced user guide for using pecan from the command line. 

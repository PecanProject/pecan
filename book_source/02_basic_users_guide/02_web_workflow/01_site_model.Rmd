...
3. If selecting your model causes your **site to disappear** from the Google Map, that means site exists but there are no drivers for that model-site combination registered in the database. 

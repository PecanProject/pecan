...
Multi-settings allows you to do multiple runs across different sites that belong to the same site group. It takes your settings and applies the same settings, only changing the site level tags.

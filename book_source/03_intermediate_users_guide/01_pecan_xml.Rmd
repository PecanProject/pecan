...
- [Advanced features](#xml-advanced)
	...
	- [`multi.site`](#xml-multi-site) -- Multi Site Settings
...
##### `pft.site` If you're interested to use a specific PFT for your site/sites you can use the following tag to tell interanl functions, which PFT needs to be used for what site.
```
<pft.site>
...
```
Then pecan would use this lookup table to inform `write.ensemble.config` function about what PFT need to be used for what site.
...
### Multi-site {#xml-multi-site}

The following tags can be used to run a simulation at multiple sites. It leverages site groups, which are defined in BETY.

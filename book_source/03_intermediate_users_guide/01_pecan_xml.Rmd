...
## `database`: Bety and other database settings

### `bety`: Bety configuration
...
### `dbfiles`: Location of database files
...
### (Experimental) `fia`: FIA database connection parameters
...
## `pft`: Plant functional type selection
...
## `meta.analysis`: Trait Meta Analysis

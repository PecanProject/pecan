...
Availbe sampling methods for `parameters` can be found in the documentation of the `get.ensemble.samples` function in `PEcAn.utils` package.
...
The resatrt functionality is developed using model specific functions by called write_restart.modelname. You need to make sure first that this function is already exsit for your dersired model.

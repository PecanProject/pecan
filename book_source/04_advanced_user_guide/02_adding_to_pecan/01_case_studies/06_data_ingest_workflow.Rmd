...
This tutorial explains the process of ingesting data into PEcAn via our Data-Ingest Application. This process consists of a few main steps. First, users select data that they wish to upload. Then, they enter metadata to help PEcAn parse and load the data into the main PEcAn workflow. Note that it is also possible to load data directly to PEcAn's BETY database, although a much less intuitive process.  

...
###### Example 3: Converting PalEON data

In addition to location-specific soil data, PEcAn can extract soil texture information from the gSSURGO data product. This product needs no installation and it extract soil proeprties for the 48 lower states in U.S. In order to let the pecan know that you're planning to use gSSURGO, you can the fllowing XML tag under input in your pecan xml file.

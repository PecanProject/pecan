...
```{r libraries, message=FALSE,echo=FALSE, eval=FALSE}
library("PEcAn.all")
```
...
```{r load-settings, message=FALSE,echo=FALSE, eval=FALSE}
...
```{r prepare-settings, message=FALSE,echo=FALSE, eval=FALSE}
...
```{r convert-settings, message=FALSE,echo=FALSE, eval=FALSE}
...
```{r meta-analysis, message=FALSE,echo=FALSE, eval=FALSE}
...
```{r run.write.configs, message=FALSE,echo=FALSE, eval=FALSE}
...
```{r run-model, message=FALSE,echo=FALSE, eval=FALSE}
if (!is.list(settings$host) || length(settings$host) > 1) {
  settings$host <- list(name = as.character(settings$host)[1])
}
...
- `PEcAn.workflow::run.sensitivity.analysis(settings)`  
  ...
  - To enable sensitivity analysis, see [PEcAn Sensitivity Analysis Documentation](https://pecanproject.github.io/pecan-documentation/master/demo-2.html).  
...
- `PEcAn.workflow::run.ensemble.analysis(settings)`  
  ...
  - Learn more about ensemble analysis settings [here](https://pecanproject.github.io/pecan-documentation/master/demo-2.html).  

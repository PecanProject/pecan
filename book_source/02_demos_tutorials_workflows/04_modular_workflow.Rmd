...
```{r libraries, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
library("PEcAn.all")
```
...
```{r load-settings,, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r prepare-settings,, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r convert-settings, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r meta-analysis, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r run.write.configs, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
...
```{r run-model, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}
if (!is.list(settings$host) || length(settings$host) > 1) {
  settings$host <- list(name = as.character(settings$host)[1])
}
...
```{r model-analyses, message=FALSE, warning=FALSE, echo=FALSE, eval=FALSE}

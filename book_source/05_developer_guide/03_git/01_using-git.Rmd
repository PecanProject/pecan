...
* To make substantial changes and/or plan to contribute over see [Recommended Workflow: A new branch for each change].                                             
...
* **develop** - Main Branch containing the latest code. This is the main brancy you will make changes to. 
...
We do not recommend using this workflow is you plan on continuously contributing to PEcAn

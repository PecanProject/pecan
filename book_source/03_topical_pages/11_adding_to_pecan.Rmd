...
**Processing meteorological data outside the workflow using PEcAn functions**
...
**Example 1: Processing vegetation data from local files**
...
* What is the file MIME type?
  - We have a suite of functions for loading in data in open formats such as CSV, txt, netCDF, etc.

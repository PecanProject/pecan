...
```
## $inputs
##                sitename model_name revision tag                      hostname file_name
## 1 Willow Creek (US-WCr)     SIPNET      ssr met ebi-forecast.igb.illinois.edu  wcr.clim
## 2 Willow Creek (US-WCr)     SIPNET      ssr met                        docker  wcr.clim

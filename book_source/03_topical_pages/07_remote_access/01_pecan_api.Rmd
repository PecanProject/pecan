...
* __Runs:__
  * `GET /api/runs`:  Get the list of all the runs
  * `GET /api/runs/{run_id}`: Fetch the details of a specified PEcAn run
  * `GET /api/runs/{run_id}/graph/{year}/{y_var}`: Plot the graph of desired output variables for a run

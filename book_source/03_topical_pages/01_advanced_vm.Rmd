...
The PEcAn VM is distributed with specific versions of PEcAn compiled. However, you do not need to constantly download the VM in order to update your code and version of BETY. To update and maintain your code you can follow the steps found in the Developer section in [Updating PecAn and Code and BETY Database](#updatebety). However, if you are using the latest version of the PEcAn VM (>=1.7) you have the Dockerized versoin of PEcAn and need to follow the instructions under the [DOCKER](#docker-index) section to update your PEcAn and BETY containers.

...
| Model Information |                                      |
| --                | --                                   |
| Home Page         | https://docs.google.com/document/d/1xDfWI0X_W7pNTEVBr1d_XwSPw5CsEBBXfBLq0LhwPGc |
| Source Code       | https://github.com/PecanProject/pecan/tree/develop/models/linkages |
| Package Docs      | https://pecanproject.r-universe.dev/PEcAn.LINKAGES |
| License           | BSD 3-clause                         |
| Authors           | Mike Dietze, Ann Raiho               |
| PEcAn Integration | See [Package README](https://github.com/PecanProject/pecan/blob/develop/models/linkages/README.md) |

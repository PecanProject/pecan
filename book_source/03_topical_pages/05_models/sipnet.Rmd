...
| Model Information |                                      |
| --                | --                                   |
| Home Page         | https://github.com/PecanProject/pecan/tree/develop/models/sipnet |
| Source Code       | https://github.com/PecanProject/pecan/tree/develop/models/sipnet |
| Package Docs      | https://pecanproject.r-universe.dev/PEcAn.SIPNET |
| License           | BSD 3-clause                         |
| Authors           | Mike Dietze (PEcAn integration)      |
| PEcAn Integration | See [Package README](https://github.com/PecanProject/pecan/blob/develop/models/sipnet/README.md) |

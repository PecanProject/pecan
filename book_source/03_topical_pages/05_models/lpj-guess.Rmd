...
| Model Information |                                      |
| --                | --                                   |
| Home Page         | http://iis.lsce.ipsl.fr/jeremie/LPJ-GUESS/ |
| Source Code       | https://github.com/PecanProject/pecan/tree/develop/models/lpjguess |
| Package Docs      | https://pecanproject.r-universe.dev/PEcAn.LPJGUESS |
| License           | BSD 3-clause                         |
| Authors           | Tony Gardella (PEcAn integration)    |
| PEcAn Integration | See [Package README](https://github.com/PecanProject/pecan/blob/develop/models/lpjguess/README.md) |

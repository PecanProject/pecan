...
Obtaining LDNDC program requires credentials, which the user is able to request from the authors of the model. With the credentials, the pre-compiled  LDNDC program can be downloaded here: https://ldndc.imk-ifu.kit.edu/download/download-model.php

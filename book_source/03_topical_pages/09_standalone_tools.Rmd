...
- Radiative transfer modeling and remote sensing ([`PEcAnRTM`](https://pecanproject.github.io/package-documentation/develop/PEcAnRTM/)); [vignette](https://pecanproject.github.io/package-documentation/develop/PEcAnRTM/articles/pecanrtm.vignette.html)
- Photosynthesis ([`PEcAn.photosynthesis`](https://pecanproject.github.io/package-documentation/develop/PEcAn.photosynthesis/)); [vignette](https://pecanproject.github.io/package-documentation/develop/PEcAn.photosynthesis/articles/ResponseCurves.html)
- Allometry ([`PEcAn.allometry`](https://pecanproject.github.io/package-documentation/develop/PEcAn.allometry/)); [vignette](https://pecanproject.github.io/package-documentation/develop/PEcAn.allometry/articles/AllomVignette.html)
- Load data ([`PEcAn.benchmark`](https://pecanproject.github.io/package-documentation/develop/PEcAn.benchmark/) -- `PEcAn.benchmark::load_data`)
...
knitr::include_graphics("02_demos_tutorials_workflows/02_user_demos/07_advanced_user_guide/images/Input_ID_name.png")
```
...
* [Sentinel-2 MSI](https://developers.google.com/earth-engine/datasets/catalog/COPERNICUS_S2_SR) [`gee2pecan_s2()`](https://github.com/PecanProject/pecan/blob/develop/modules/data.remote/inst/RpTools/RpTools/gee2pecan_s2.py). It is possible to estimate Leaf Area Index (LAI) from Sentinel-2 data using the [ESA SNAP algorithm](https://github.com/PecanProject/pecan/blob/develop/modules/data.remote/inst/RpTools/RpTools/biophys_xarray.py).
* [SMAP Global Soil Moisture Data](https://developers.google.com/earth-engine/datasets/catalog/NASA_USDA_HSL_SMAP_soil_moisture) [`gee2pecan_smap()`](https://github.com/PecanProject/pecan/blob/develop/modules/data.remote/inst/RpTools/RpTools/gee2pecan_smap.py)
* [Landsat 8 Surface Reflectance](https://developers.google.com/earth-engine/datasets/catalog/LANDSAT_LC08_C01_T1_SR) [`gee2pecan_l8()`](https://github.com/PecanProject/pecan/blob/develop/modules/data.remote/inst/RpTools/RpTools/gee2pecan_l8.py)

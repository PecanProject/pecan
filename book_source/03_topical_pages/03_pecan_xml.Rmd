...
<state.data.assimilation>
  <Obs_Prep>
   ...
   <obs_outdir>/projectnb/dietzelab/dongchen/All_NEON_SDA/test_OBS</obs_outdir>
   <start.date>2012-07-15</start.date>
   <end.date>2021-07-15</end.date>
  </Obs_Prep>
</state.data.assimilation>
...
* **obs_outdir** : [required] This tag defines the directory where to export the obs.mean and obs.cov Rdata files.

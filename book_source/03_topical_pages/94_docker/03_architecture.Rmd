...
The Minio interface is accessible by browsing to `pecan.localhost/minio/`.
...
Note that the `traefik.frontend.rule` indicates that browsing to http://pecan.localhost/rabbitmq/ leads to the RabbitMQ management console.

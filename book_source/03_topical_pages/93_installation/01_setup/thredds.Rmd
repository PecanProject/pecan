...
<threddsConfig>
  ...
  <!-- see https://docs.unidata.ucar.edu/tds/current/userguide/tds_config_ref.html -->
  <serverInformation>
    <name>PEcAn</name>
  ...
  see https://docs.unidata.ucar.edu/netcdf-java/current/userguide/runtime_loading.html

...
Once this has build correctly you should be able to add the image to the `docker-compose.yml` file you use to run PEcAn and be able to use this model in the web interface.

...
7. Start Pecan by double clicking on the icon for the VM. A terminal window will pop up showing the machine booting up which may take a minute. It is done booting when you get to the “pecan32 login:” prompt. You do not need to login as the VM behaves like a server that we will be accessing through you web browser. Feel free to minimize the VM window.
    ...
    * If you _do_ want to login to the VM, the credentials are as follows: `username: carya`, `password: illinois` (after the pecan tree, [Carya illinoinensis](https://en.wikipedia.org/wiki/Pecan)).
...
9.	Instances 
    +  You will see the status of your PEcAn VM, which will take a minute to boot up. Wait until the Instance State reads “running”. The most important piece of information here is the Public IP, which is the URL you will need in order to access your PEcAn instance from within your web browser (see [Demo 1](https://pecanproject.github.io/pecan-documentation/tutorials/Demo01.html)).
...
|:--:|:---:|:------:|:---------:|
|Demo| Basic Run| [Webpage](https://pecanproject.github.io/pecan-documentation/tutorials/Demo01.html) | [Rmarkdown File](https://github.com/PecanProject/pecan/blob/develop/documentation/tutorials/01_Demo_Basic_Run/Demo01.Rmd)|
|Demo| Uncertainty Analysis| Webpage| [RmardkdownFile](https://github.com/PecanProject/pecan/tree/master/documentation/tutorials/02_Demo_Uncertainty_Analysis)|
|Vignette| Output Analysis|Webpage |[RmardkdownFile](https://github.com/PecanProject/pecan/tree/develop/documentation/tutorials/AnalyzeOutput)|
|Vignette| MCMC |Webpage|[RmardkdownFile](https://github.com/PecanProject/pecan/tree/develop/documentation/tutorials/MCMC)|
|Vignette|Parameter Assimilation |Webpage |[RmardkdownFile](https://github.com/PecanProject/pecan/tree/develop/documentation/tutorials/ParameterAssimilation)|
|Vignette|State Assimilation|Webpage|[RmardkdownFile](https://github.com/PecanProject/pecan/tree/develop/documentation/tutorials/StateAssimilation)|
|Vignette| Sensitivity|Webpage|[RmardkdownFile](https://github.com/PecanProject/pecan/tree/develop/documentation/tutorials/sensitivity)|

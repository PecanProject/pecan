...
vmap_reverse <- list(
  ...
  "AutoResp"   = c(depends_on="RM,RG", longname="Autotrophic Respiration", newunits="kg C m-2 s-1"),
  ...
  "NetNMin"    = c(depends_on="NETNMIN", longname="Net N Mineralization", newunits="kg N m-2 s-1"),
  "NImmob"     = c(depends_on="NIMMOB", longname="N Immobilization", newunits="kg N m-2 s-1"),
  "NInput"     = c(depends_on="NINPUT", longname="N Inputs to soil", newunits="kg N m-2 s-1"),
  "NLost"      = c(depends_on="NLOST", longname="N Lost from soil", newunits="kg N m-2 s-1"),
  "NUptakeIn"  = c(depends_on="NUPTAKEIN", longname="N Uptake ignoring N limitation", newunits="kg N m-2 s-1"),
  "NUptakeSt"  = c(depends_on="NUPTAKEST", longname="N Uptake Structural", newunits="kg N m-2 s-1"),
  "NUptakeLab" = c(depends_on="NUPTAKELAB", longname="N Uptake Labile", newunits="kg N m-2 s-1"),
  "OrgN"       = c(depends_on="ORGN", longname="Total Soil Organic N", newunits="kg N m-2"),
  "ShlwC"      = c(depends_on="SHLWC", longname="Shallow (fibrous) soil C", newunits="kg C m-2"),
  "VegN"       = c(depends_on="VEGN", longname="Vegetation N", newunits="kg N m-2")

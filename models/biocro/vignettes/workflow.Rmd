...
## load met data
start.model.runs(model, settings)         # Start ecosystem model runs
read.outputs(model, settings, variables = "Stem")
get.model.output(model, settings)         # Get results of model runs

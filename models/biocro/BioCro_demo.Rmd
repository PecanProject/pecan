...
settings$database <- list(driver = "PostgreSQL", dbname = "ebi_production", user = "bety", host = "ebi-forecast.igb.illinois.edu", password = "bety")
model <- settings$model$name
settings$model$binary <- "/home/dlebauer/dev/pecan/models/biocro/inst/biocro.Rscript"

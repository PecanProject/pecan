...
site_fluxes <- function(model.run, in.dir, out.dir) {
  ...
  for (year in start_year:end_year) {
    ...
    filename <- list.files(in.dir,
      full.names = TRUE,
      pattern = paste(".*-T-", year, "-.*.h5", sep = "")
    )[1]
    if (is.na(filename) == 1) {
      break
    } else {
    ...
    ###########################################################################################################
    ##################################### COMPONENT FLUXES ####################################################
    pdf(paste(out.dir, "/", "ED2_", year, "_Site_Avg_Fluxes.pdf", sep = ""),
      width = 12, height = 11,
      onefile = TRUE
    )
    ...
    plot(start_day:end_day, GPP.AVG.mn,
      xlab = "", ylab = expression(paste(GPP, " (gC", ~ m^{
        -2
      }, ")")),
    ...
    points(start_day:end_day, GPP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    if (is.nan(mean(chk)) == 0) {
      legend("topleft",
        legend = c("Greenup", "Leaf Off"), bty = "n",
    ...
    plot(start_day:end_day, NPP.AVG.mn,
      xlab = "", ylab = expression(paste(NPP, " (gC", ~ m^{
        -2
      }, ")")),
    ...
    points(start_day:end_day, NPP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, PLANT.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[a], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
    ...
    points(start_day:end_day, PLANT.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, HTROPH.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[h], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    ...
    points(start_day:end_day, HTROPH.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, Reco.AVG.mn,
      xlab = paste("DOY", as.character(year)), ylim = ylim,
      ylab = expression(paste(italic(R)[eco.], " (gC", ~ m^{
        -2
      }, ")")),
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    ...
    points(start_day:end_day, Reco.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, NEE.AVG.mn,
      xlab = paste("DOY", as.character(year)), ylim = ylim,
      ylab = expression(paste(NEE, " (gC", ~ m^{
        -2
      }, ")")),
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    ...
    points(start_day:end_day, NEE.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, LEAF.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[leaf], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    polygon(c(polyx, rev(polyx)), c(LEAF.RESP.AVG.ul, rev(LEAF.RESP.AVG.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, LEAF.RESP.AVG.mn, lty = 1, col = "black")
    points(start_day:end_day, LEAF.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, ROOT.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[root], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    polygon(c(polyx, rev(polyx)), c(ROOT.RESP.AVG.ul, rev(ROOT.RESP.AVG.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, ROOT.RESP.AVG.mn, lty = 1, col = "black")
    points(start_day:end_day, ROOT.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, GROWTH.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[growth], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    polygon(c(polyx, rev(polyx)), c(GROWTH.RESP.AVG.ul, rev(GROWTH.RESP.AVG.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, GROWTH.RESP.AVG.mn, lty = 1, col = "black")
    points(start_day:end_day, GROWTH.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, STORAGE.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(R)[growth], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(STORAGE.RESP.AVG.ul, rev(STORAGE.RESP.AVG.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, STORAGE.RESP.AVG.mn, lty = 1, col = "black")
    points(start_day:end_day, STORAGE.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, VLEAF.RESP.AVG.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(italic(VR)[leaf], " (gC", ~ m^{
        -2
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    polygon(c(polyx, rev(polyx)), c(VLEAF.RESP.AVG.ul, rev(VLEAF.RESP.AVG.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, VLEAF.RESP.AVG.mn, lty = 1, col = "black")
    points(start_day:end_day, VLEAF.RESP.AVG.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.VAPOR.LC.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(V. ~ Flux[veg ~ to ~ CAS], " (kg", ~ m^{
        -2
      } ~ s^{
        -1
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(AVG.VAPOR.LC.ul, rev(AVG.VAPOR.LC.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.VAPOR.LC.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.VAPOR.LC.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.VAPOR.GC.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(V. ~ Flux[ground ~ to ~ CAS], " (kg", ~ m^{
        -2
      } ~ s^{
        -1
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(AVG.VAPOR.GC.ll, rev(AVG.VAPOR.GC.ul)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.VAPOR.GC.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.VAPOR.GC.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.VAPOR.AC.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(V. ~ Flux[atm. ~ to ~ CAS], " (kg", ~ m^{
        -2
      } ~ s^{
        -1
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(AVG.VAPOR.AC.ul, rev(AVG.VAPOR.AC.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.VAPOR.AC.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.VAPOR.AC.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.TRANSP.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(Transpiration, " (kg", ~ m^{
        -2
      } ~ s^{
        -1
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(AVG.TRANSP.ul, rev(AVG.TRANSP.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.TRANSP.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.TRANSP.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.EVAP.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(Evaporation, " (kg", ~ m^{
        -2
      } ~ s^{
        -1
      }, ")")), pch = 21, col = "black",
    ...
    polygon(c(polyx, rev(polyx)), c(AVG.EVAP.ul, rev(AVG.EVAP.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.EVAP.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.EVAP.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
    ...
    plot(start_day:end_day, AVG.CAN.SHV.mn,
      xlab = "", ylim = ylim,
      ylab = expression(paste(Sp.Humidity[CAS], " (kg", ~ kg^{
        -1
      }, ")")), pch = 21, col = "black",
      bg = "black", cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    polygon(c(polyx, rev(polyx)), c(AVG.CAN.SHV.ul, rev(AVG.CAN.SHV.ll)),
      col = "light gray",
      border = "dark grey", lty = 2
    )
    lines(start_day:end_day, AVG.CAN.SHV.mn, lty = 1, col = "black")
    points(start_day:end_day, AVG.CAN.SHV.mn,
      pch = 21, col = "black", bg = "black",
      cex = cex, cex.lab = labcex, cex.axis = axiscex, cex.main = maincex
    )
    abline(h = 0, lty = 2, lwd = 1.5, col = "black")
...
plot_monthly <- function(model.run, in.dir, out.dir) {
  ...
  for (year in start_year:end_year) {
    ...
    #------------------------------------------------------------------------------------------#
    pdf(paste(out.dir, "/", "ED2_", year, "_Monthly_Mean_Output.pdf", sep = ""),
      width = 10, height = 10,
      onefile = TRUE
    )
    ...
    lai.xlab <- "Month"
    lai.ylab <- expression(paste("LAI (", m^{
      2
    } ~ m^{
      -2
    }, ")")) # "LAI [m2/m2]"
    ...
    plot(
      x = when, y = lai.pft[, 1], type = "n", ylim = lai.ylim, xaxt = "n",

...
trait.dictionary <- function(traits = 'all') {
  defs<-data.frame(id = c( "c2n_leaf", "dark_respiration_factor", "f_labile", "growth_resp_factor", "leaf_turnover_rate", "leaf_width", "mort2", "nonlocal_dispersal", "fineroot2leaf", "quantum_efficiency", "root_respiration_factor", "root_turnover_rate", "SLA", "stomatal_slope", "Vm0", "Vm_low_temp", "water_conductance","cuticular_cond","seedling_mortality","r_fract","storage_turnover_rate", "T"),
                   fileid = c("c2nleaf", "darkresp", "flabile", "growthresp", "leaftnvrrate", "leafwidth", "mort2", "nldisprs", "fineroot2leaf", "quantef", "rtresp", "rttnvrrate", "SLA", "stmslope", "Vm0", "Vmlowtemp", "h2ocndctnc", "cuticularcond","seedlingmortality","rfract","storagetnvrrate","T"),

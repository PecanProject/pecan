trait.dictionary <- function() {
  ...
  trait.defs<-data.frame(
                         id = c( "c2n_leaf", "dark_respiration_factor", "f_labile", "growth_resp_factor", "leaf_turnover_rate", "leaf_width", "mort2", "nonlocal_dispersal", "q", "quantum_efficiency", "root_respiration_factor", "root_turnover_rate", "SLA", "stomatal_slope", "Vm0", "Vm_low_temp", "water_conductance","cuticular_cond","seedling_mortality","r_fract","storage_turnover_rate"),

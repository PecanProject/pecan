...
ma.model <- function(){
  for (k in 1:LENGTHK){
    ...
    Z[k] <- b.trt[trt[k]] + theta[site[k]]      # linear model with random treatment and site effects

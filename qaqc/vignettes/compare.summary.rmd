...
```{r}
library(plotrix)
load(system.file("inst/extdata/prior","output.Rdata",package="PEcAn.qaqc"))
priors <- ensemble.output
load(system.file("inst/extdata/post","output.Rdata",package="PEcAn.qaqc"))
...
paviyield <- read.csv(system.file("inst/extdata","wang2010data.csv",package="PEcAn.qaqc"), sep = ';', header = F)

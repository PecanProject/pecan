...
*   **Results**:
    *   `trait.mcmc.rds`: The raw MCMC (Markov Chain Monte Carlo) samples from the Bayesian analysis. This contains the full posterior chains.
    ...
    *   `post.distns.MA.rds`: A specific version of the posterior distributions generated by the meta-analysis module.
...
This will produce the same `trait.mcmc.rds` and `post.distns.Rdata` files in the output directory specified in the settings.

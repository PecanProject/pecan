...
arun <- read.output(runids[r],paste(settings$outdir, "out", runids[1], sep="/"),2004,2004,"NEE", dataframe= TRUE)
plottable<-align_data(model.calc = arun, obvs.calc = obs, align_method = "match_timestep", var= "NEE")
...
```{r,eval=FALSE}
unc <- PEcAn.settings::flux.uncertainty(plottable$NEE.o,QC=rep(0,17520)) 

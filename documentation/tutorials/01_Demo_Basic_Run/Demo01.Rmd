...
```{r startpecan}
knitr::include_graphics('figures/startpecan.jpg')
```

### Site Selection

```{r mapmodel}
knitr::include_graphics('figures/mapmodel.png')
```
...
```{r runspec}
knitr::include_graphics('figures/runspec.png')
```
...
```{r execstatus}
knitr::include_graphics('figures/execstatus.jpg')
```
...
```{r workflowshiny}
knitr::include_graphics('figures/workflowshiny.png')
```

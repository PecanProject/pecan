...
```{r setup}
tutorial_dir <- '../documentation/tutorials/01_Demo_Basic_Run'
```
...
*	If you [downloaded the PEcAn VM][pecandl], **URL = localhost:6480**
*	If you are [running PEcAn on Amazon AWS][pecanaws], **URL is the Public IP**
*	If you [installed PEcAn on your server][pecanserver], **URL is your server’s IP**

[pecandl]: https://pecanproject.github.io/pecan-documentation/getting-started.html#working-with-the-pecan-vm
[pecanaws]: https://pecanproject.github.io/pecan-documentation/getting-started.html#using-amazonweb-services-aws
[pecanserver]: https://pecanproject.github.io/pecan-documentation/installing-pecan.html
...
```{r startpecan}
knitr::include_graphics(file.path(tutorial_dir, 'startpecan.jpg'))
```

## Site Selection

```{r mapmodel}
knitr::include_graphics(file.path(tutorial_dir, 'mapmodel.png'))
```

### Host

**Select the local machine “pecan”**. Other options exist if you’ve configured PEcAn to [run models on remote servers][remoterun]. 

[remoterun]: https://pecanproject.github.io/pecan-documentation/Enabling-Remote-Execution.html


### Mode

Select **SIPNET** from the [available models][availmodels] because it is quick & simple.

[availmodels]: https://pecanproject.github.io/pecan-documentation/pecan-models.html
...
```{r runspec}
knitr::include_graphics(file.path(tutorial_dir, 'runspec.png'))
```
...
**Select “Use AmerifluxLBL”** from the [available meteorological drivers][metdrivers].

[metdrivers]: https://pecanproject.github.io/pecan-documentation/available-meteorological-drivers.html
...
```{r execstatus}
knitr::include_graphics(file.path(tutorial_dir, 'execstatus.jpg'))
```
...
```{r workflowshiny}
knitr::include_graphics(file.path(tutorial_dir, 'workflowshiny.png'))
```
...
Follow [this tutorial](https://github.com/PecanProject/pecan/tree/master/documentation/tutorials/AnalyzeOutput) to learn how to **open model output in R and compare to observed data**


## DEMO 02
[This tutorial](https://github.com/PecanProject/pecan/tree/master/documentation/tutorials/02_Demo_Uncertainty_Analysis) will show how to perform **Ensemble & Sensitivity Analyses** through the web interface and explore the PEcAn outputs in greater detail, including the **trait meta-analysis**

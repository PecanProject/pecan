...
All model outputs are converted to [standard netCDF format](https://nacp-prod.ornl.gov/MsTMIP_variables.shtml)
...
FYI, [adding a new model](https://pecanproject.github.io/pecan-documentation/develop/adding-model.html) to PEcAn does not require modification of the model’s code, just the implementation of a wrapper function.
...
3. Variable names and units are based on a [standard netCDF format](https://nacp-prod.ornl.gov/MsTMIP_variables.shtml).

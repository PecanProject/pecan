...
```{r}
library(PEcAn.utils)
out <- read.output(1000000993,"output/PEcAn_1000000993/out/1000333705",2004,2004,c("time","NEE"))
...
#
#input_id <- 1000011260
#File_Path<-query.file.path(input_id,settings$host$name, bety$con)
File_Path<-"/fs/data3/tmccabe/valicali/AMF_US-Dk3_NO_HEADER.txt"
File_format<-query.format.vars(bety = bety, format.id = 5000000002)
test<-load_data(data.path = File_Path, format= File_format)
```

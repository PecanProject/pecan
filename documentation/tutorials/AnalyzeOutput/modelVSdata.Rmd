...
settings<-PEcAn.settings::read.settings("/fs/data2/output//PEcAn_1000007658/pecan.xml")
...
aligned_dat = PEcAn.benchmark::align_data(model.calc = model, obvs.calc= observations, var ="NEE", align_method ="mean_over_larger_timestep")

...
```{r}
File_format<-PEcAn.DB::query.format.vars(bety = bety, format.id = 24) #This matches the file with a premade "format" or a template that describes how the information in the file is organized

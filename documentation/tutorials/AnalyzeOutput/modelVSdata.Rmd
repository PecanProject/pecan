...
```{r}
## Read in the xml
settings<-read.setting("filepath/custom.xml")
...
model <- read.output(runid,outdir,start.year, end.year, model_vars,dataframe=TRUE)
```
...
File_Path<-"~/output/dbfiles/AmerifluxLBL_site_0-772/AMF_US-NR1_BASE_HH_9-1.csv" #This is a path to where the observations are stored. 
...
site<-query.site(site.id,bety$con) #This tells PEcAn where the data comes from

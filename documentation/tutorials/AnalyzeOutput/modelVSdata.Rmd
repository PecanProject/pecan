...
#bety = list(host = "psql-pecan.bu.edu", driver = "PostgreSQL", user = "bety", dbname = "bety", password = "bety", con= list())
#bety$con <- src_postgres(host = bety$host, user = bety$user, password = bety$password, dbname = bety$dbname)


bety<-list(host = "psql-pecan.bu.edu", driver = "PostgreSQL", user = "bety", dbname = "bety", password = "bety")
bety <- src_postgres(host = bety$host, user = bety$user, password = bety$password, dbname = bety$dbname)
```
...
File_Path refers to where you stored your observational data. In this example the default file path is an Ameriflux dataset from Duke Forest. 
...
aligned_dat = align_data(model.calc = model, obvs.calc= observations, var ="NEE", start_year =start_year, end_year = end_year, align_method ="mean_over_larger_timestep")

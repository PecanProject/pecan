fluidRow(
  title = "New Input",
  box(
    title = h2("New Input"), width = 4, collapsible = TRUE,
    hr(),
  ...
  box(
    title = h2("DbFiles Record"), width = 4, collapsible = TRUE, collapsed = TRUE,
    hr(),
    selectizeInput("InputMachineName",
      label = "Machine *", choices = NULL, # remember to set default to local
      options = list(
  ...
  box(
    title = h2("Format ID"), width = 4, collapsible = TRUE, collapsed = TRUE,
    hr(),

fluidPage(
  fluidRow(
    ...
    box(
      ...
      shinyWidgets::radioGroupButtons("inputMethod",
      ...
      div(
        ...
        box(
          ...
          fluidRow(
            column(
              6,
              selectizeInput("InputSiteName",
                label = "Site *", choices = NULL,
                options = list(
            ...
            column(
              6,
              selectizeInput("InputParentName",
                label = "Parent *", choices = NULL,
                options = list(
          ...
          fluidRow(
            column(
              6,
              selectizeInput("InputFormatName",
                label = "Format *", choices = NULL,
                options = list(
            ...
            column(
              6,
              selectizeInput("MimetypeNameCurrent",
                label = "Corresponding Mimetype *", choices = NULL,
                options = list(
          ...
          shinyWidgets::dropdownButton(
            circle = FALSE, label = "Create New Format", width = "350px",
            box(
              width = "350px", solidHeader = TRUE, status = "warning",
              selectizeInput("MimetypeName",
                label = "Mimetype *", choices = NULL,
                options = list(
          ...
          fluidRow(
            ...
            column(
              3 ## Now I'm not sure if we need timezone since sites are known
  ...
  fluidRow(
    ...
    shinyjs::hidden(
      div(
        id = "formats.vars_box",
        box(
          title = h2("3. Formats-Variables"), width = 12, solidHeader = TRUE, status = "success", collapsible = TRUE, collapsed = FALSE,
          fluidRow(
            column(
              3,
              selectizeInput("pecan_var",
                choices = NULL, label = "Variable",
                options = list(

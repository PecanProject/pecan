...
This is also the most important step! Navigate to the written out table and *delete entries that should remain in the database*. If the tables are dificult to read, change what columns are retained by editing the "relevant_table_columns" parameter.

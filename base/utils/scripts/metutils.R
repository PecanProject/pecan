...
if (args[3] == 1) {
  ...
  vars <- list(
    "vgrd", "vddsf", "vbdsf", "ugrd", "Tair", "sh", "pres", "prate", "cumprcp",
  ...
  plot(xaxis, vgrd,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(Wind[meridional], " (", m ~ s^{
      -1
    }, ")")), cex = ptcex,
  ...
  plot(xaxis, vddsf,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(Vis.Rad.[diffuse], " (", W ~ m^{
      -2
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )
  ...
  plot(xaxis, vbdsf,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(Vis.Rad.[beam], " (", W ~ m^{
      -2
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )
  ...
  plot(xaxis, ugrd,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(Wind[zonal], " (", m ~ s^{
      -1
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )
  ...
  plot(xaxis, prate,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste("Precip.", " (kg H2O ", m^{
      -2
    } ~ s^{
      -1
    }, ")")),
  ...
  plot(xaxis, cumprcp,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste("Cumulative Precip.", " (kg H2O ", m^{
      -2
    } ~ s^{
      -1
    }, ")")),
  ...
  plot(xaxis, nddsf,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(IR.Rad.[diffuse], " (", W ~ m^{
      -2
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )
  ...
  plot(xaxis, nbdsf,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(IR.Rad.[beam], " (", W ~ m^{
      -2
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )
  ...
  plot(xaxis, dlwrf,
    pch = 21, bg = "dark grey", col = "dark grey", xaxt = "n", xlab = "Year",
    ylab = expression(paste(LW.Rad.[downward], " (", W ~ m^{
      -2
    }, ")")), cex = ptcex,
    cex.lab = labcex, cex.axis = axcex
  )

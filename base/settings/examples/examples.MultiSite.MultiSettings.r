dontrun <- function() { # Added by Alexey Shiklomanov
  ...
  template <- Settings(list(
    ...
    pfts = structure(list(
      pft = structure(
        list(
          comment = NULL, name = "temperate.Evergreen_Hardwood",
    ...
    .Names = c(
      "id", "edin", "config.header", "phenol.scheme", "prerun",
      "binary"
    )
    ),
    host = structure(list(
      name = "geo.bu.edu", user = "rykelly",
    ...
    .Names = c(
      "name", "user", "folder", "qsub", "qsub.jobid", "qstat",
    ...
    run = structure(list(
      inputs = structure(list(
        ...
        veg = structure(list(
          id = "296",
          path = "/projectnb/dietzelab/EDI/oge2OLD/OGE2_"
        ),
        .Names = c("id", "path")
        ),

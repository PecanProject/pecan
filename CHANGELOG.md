...
- `gSSURGO.Query()` in PEcAn.data.land is deprecated in favor of `extract_soil_gssurgo()` which uses the modern `soilDB` package. `gSSURGO.Query()` will be removed in a future release. (#3697)

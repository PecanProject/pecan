...
cf.id <- PEcAn.DB::convert.input(input.id,outfolder,pkg,fcn,write,username,con) # doesn't update existing record
}
...
perm.id <- PEcAn.DB::convert.input(input.id,outfolder,pkg,fcn,write,username,con)
}
...
extract.id <- PEcAn.DB::convert.input(input.id,outfolder,pkg,fcn,write,username,con,newsite = newsite)
}
...
model.id <- PEcAn.DB::convert.input(input.id,outfolder,pkg,fcn,write,username,con,lst=lst,overwrite=overwrite)
}

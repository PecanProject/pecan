...
metgapfill(lst=-7, overwrite=FALSE, in.path='~/Example/CF', in.prefix='FLX_US-NR1_FLUXNET2015_SUBSET_HH_1998-2014_1-3', outfolder='~/Example/gapfill', start_date='2010/01/01', end_date='2014/12/31')
nc.merge(in.path = "~/Example/gapfill", in.prefix = "FLX_US-NR1_FLUXNET2015_SUBSET_HH_1998-2014_1-3", outfolder = "~/Example/NR1_training_data", start_date = "2010-01-01", end_date = "2014-12-31", upscale = "hour")
```

### Generate Linear Regression Models From Training Data 

Note: This requires ~ 60 GB of space
```{r}
gen.subdaily.models(in.prefix = "US-NR1", dat.train_file = "~/Example/NR1_training_data/FLX_US-NR1_FLUXNET2015_SUBSET_HH_1998-2014_1-3_dat.train", outfolder = "~/Example/lm_model_output", n.beta = 10, day.window = 5)
```

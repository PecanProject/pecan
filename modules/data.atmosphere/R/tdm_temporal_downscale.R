...
predict.subdaily <- function(dat.mod, n.ens, path.model, lags.list = NULL, 
    ...
    # surface_downwelling_shortwave_flux_in_air 2.4
    # surface_downwelling_longwave_flux_in_air 2.5 air_pressure (surface
    # air_pressure) 2.6 specific_humidity (specific humidity) 2.7

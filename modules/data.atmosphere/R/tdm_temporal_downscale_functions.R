...
# Each variable goes through a unique process for downscaling.
# temporal.downscale.functions is a dummy function strictly used for
...
##' Predict Subdaily Meteorology Function

##' Predict Subdaily Meteorology based off of linear regression statistics created in tdm_generate_subdaily_models.R
...
##' @param start_date
##' @param end_date
##' @param tdf_file - tdm_temporal_downscale_functions.R filepath that can be sourced i.e. '~/scripts/temporal_downscale_functions.R'
##' @param td_file - tdm_temporal_downscale.R filepath that can be sourced i.e. '~/scripts/temporal_downscale.R'
...
predict_subdaily_met <- function(outfolder, in.path, in.prefix, lm.models.base, 
    ...
    for (y in years) {
        ...
        # ----------------------------------- Write each year for each ensemble
        # member into its own .nc file -----------------------------------

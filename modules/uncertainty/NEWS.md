...
* Fixed parent-linked input design handling and validation so parameter-selected sample indices stay aligned and in bounds during workflow configuration.

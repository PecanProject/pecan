...
```{r}
#install the package of xtable in order to run the xtable function
library(xtable)
...
## document the modules/uncertainty package again
...
#modify the modules/uncertainty/R/plots.R file. change opt into theme and all theme_text into element_text
...
## plot parameters
theme_set(theme_bw())
opt <- theme(title = "Modeled and Observed Switchgrass Yield",
            axis.text.y = element_blank(),#theme_text(size = 14 * font.adjust),
            axis.text.x = element_text(size = 14 * font.adjust),
            axis.title.x = element_text(size = 14 * font.adjust), 
            axis.title.y = element_text(size = 14 * font.adjust, angle = 90),
            plot.title = element_text(size = 16 * font.adjust), 
            panel.grid.major = element_blank(),
            panel.grid.minor = element_blank(),
            panel.border = element_rect(c("bottom","left")),

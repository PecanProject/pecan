...
##' 
##' @param trait.data list of `data.frame`s, one per trait for which data is available, generated by call to [PEcAn.DB::query.traits()]
##' @param prior.distns `data.frame` of prior distributions generated by call to [PEcAn.DB::query.priors()]
...
##' @examples
##' \dontrun{
##'   prior.distns <- PEcAn.DB::query.priors('ebifarm.c4crop', c('SLA', 'c2n_leaf'))
##'   trait.data <- PEcAn.DB::query.traits('938', c('SLA', 'c2n_leaf'))

...
converts lbs/acre to g/m2 with `PEcAn.utils::ud_convert`, and splits the wide
...
pub 8292) and grapevines (UC ANR pub 8296), Brown et al. 2020 NBMP Table 2
...
rice) come from the spreadsheet, hand-authored rather than mapped from

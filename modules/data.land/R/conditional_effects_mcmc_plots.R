...
#####################################################################################
file.base.name <- "PPT.noX2.tau_unif_0.0001_100.txt."
output.base.name <- "PPT.noX2.tau_unif_0.0001_100"
...
for(i in 393:400){ # note this model stopped early b/c convergence
...
png(height = 12, width = 8, units = "in", res = 200, paste0(workingdir,output.base.name,"_traceplots.png"))
par(mfrow=c(5,3))
...
png(height = 10, width = 8, units = "in", res = 200, paste0(workingdir,output.base.name,"_ACFplots.png")
    ...
    ## wintP
    clim.data <- readRDS("/home/rstudio/pecan/modules/data.land/R/PRISM_non_scaled.rds")

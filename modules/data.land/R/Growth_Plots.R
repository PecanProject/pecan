...
boxplot(growth2012[,12] ~ growth2012[,1], data=growth2012, horizontal=TRUE, las=1,
        xlab="2012-2002 Avg. Increment", yaxt='n', ylim=c(0,.5))

#Bartlett Growth 2002-1992
growth2012=na.exclude(cbind(fd$species,fd$increments[,189:180]))
mean2012=rowMeans(growth2012[2:11])
growth2012=cbind(growth2012,mean2012)
boxplot(growth2012[,12] ~ growth2012[,1], data=growth2012, horizontal=TRUE, las=1,
        xlab="2002-1992 Avg. Increment", yaxt='n', ylim=c(0,.5))

#Bartlett Growth 1992-1982
growth2012=na.exclude(cbind(fd$species,fd$increments[,180:171]))
mean2012=rowMeans(growth2012[2:11])
growth2012=cbind(growth2012,mean2012)
boxplot(growth2012[,12] ~ growth2012[,1], data=growth2012, horizontal=TRUE, las=1,
        xlab="1992-1982 Avg. Increment", yaxt='n', ylim=c(0,.5))

#Bartlett Growth 1982-1972
growth2012=na.exclude(cbind(fd$species,fd$increments[,171:162]))
mean2012=rowMeans(growth2012[2:11])
growth2012=cbind(growth2012,mean2012)
boxplot(growth2012[,12] ~ growth2012[,1], data=growth2012, horizontal=TRUE, las=1,
        xlab="1992-1982 Avg. Increment", yaxt='n', ylim=c(0,.5))

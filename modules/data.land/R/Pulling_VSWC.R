...
VSWC <- ncvar_def(name = "mass fraction of unfrozen water in soil_moisture", units = "volumetric soil water content", dim = depth, 
                      missval = -999, longname = paste0(site_ID, "_", "VSWC"), prec = "integer")
soilmoisture.nc <- nc_create(paste0(site_ID, "_", "VSWC"), VSWC)

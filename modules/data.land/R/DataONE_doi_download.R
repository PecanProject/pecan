...
download_package_rm <- function(resource_map, directory, CNode = "PROD", download_format = "application/bagit-097",
  ...
  zip_contents <<- utils::unzip(bagitFile,
    files = NULL, list = FALSE, overwrite = overwrite_directory, # Unzip the bagitFile and store in directory specified under exdir

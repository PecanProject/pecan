...
#------------------------------------------------------------------------------------------#
stext.polygon <- list()
stext.polygon[[1]] <- list(
  sand = c(1.000, 0.900, 0.850),
  clay = c(0.000, 0.100, 0.000)
) # end list
stext.polygon[[2]] <- list(
  sand = c(0.900, 0.850, 0.700, 0.850),
  clay = c(0.100, 0.150, 0.000, 0.000)
) # end list
stext.polygon[[3]] <- list(
  sand = c(0.850, 0.800, 0.525, 0.525, 0.425, 0.500, 0.700),
  clay = c(0.150, 0.200, 0.200, 0.075, 0.075, 0.000, 0.000)
) # end list
stext.polygon[[4]] <- list(
  sand = c(0.500, 0.225, 0.000, 0.000, 0.075, 0.200),
  clay = c(0.000, 0.275, 0.275, 0.125, 0.125, 0.000)
) # end list
stext.polygon[[5]] <- list(
  sand = c(0.525, 0.450, 0.225, 0.425, 0.525),
  clay = c(0.200, 0.275, 0.275, 0.075, 0.075)
) # end list
stext.polygon[[6]] <- list(
  sand = c(0.800, 0.650, 0.450, 0.450, 0.525),
  clay = c(0.200, 0.350, 0.350, 0.275, 0.200)
) # end list
stext.polygon[[7]] <- list(
  sand = c(0.200, 0.000, 0.000, 0.200),
  clay = c(0.400, 0.400, 0.275, 0.275)
) # end list
stext.polygon[[8]] <- list(
  sand = c(0.450, 0.200, 0.200, 0.450),
  clay = c(0.400, 0.400, 0.275, 0.275)
) # end list
stext.polygon[[9]] <- list(
  sand = c(0.650, 0.450, 0.450),
  clay = c(0.350, 0.550, 0.350)
) # end list
stext.polygon[[10]] <- list(
  sand = c(0.200, 0.000, 0.000),
  clay = c(0.400, 0.600, 0.400)
) # end list
stext.polygon[[11]] <- list(
  sand = c(0.300, 0.300, 0.000),
  clay = c(0.400, 0.700, 0.700)
) # end list
stext.polygon[[12]] <- list(
  sand = c(NA, NA),
  clay = c(NA, NA)
) # end list
stext.polygon[[13]] <- list(
  sand = c(NA, NA),
  clay = c(NA, NA)
) # end list
stext.polygon[[14]] <- list(
  sand = c(0.200, 0.075, 0.000, 0.000),
  clay = c(0.000, 0.125, 0.125, 0.000)
) # end list
stext.polygon[[15]] <- list(
  sand = c(0.300, 0.000, 0.000),
  clay = c(0.700, 1.000, 0.700)
) # end list
stext.polygon[[16]] <- list(
  sand = c(0.450, 0.300, 0.300, 0.450),
  clay = c(0.550, 0.700, 0.400, 0.400)
) # end list
stext.polygon[[17]] <- list(
  sand = c(0.300, 0.000, 0.000, 0.200),
...
xsand.def <- c(
  0.920, 0.825, 0.660, 0.200, 0.410, 0.590,
  0.100, 0.320, 0.520, 0.060, 0.200, 0.200,
  0.333, 0.075, 0.100, 0.375, 0.125
)
xclay.def <- c(
  0.030, 0.060, 0.110, 0.160, 0.170, 0.270,
...
soil.key <- c(
  "Sa", "LSa", "SaL", "SiL", "L", "SaCL", "SiCL", "CL", "SaC", "SiC", "C", "P", "BR",
  "Si", "CC", "CSa", "CSi"
)

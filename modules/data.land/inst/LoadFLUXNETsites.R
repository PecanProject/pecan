...
for (s in 1:nsite) {
  ...
  if (length(id) == 0) {
    ...
    notes <- paste(
      "IGBP =", as.character(AMERIFLUX_table$IGBP[s]),
    ...
    InsertString <- paste0(
      "INSERT INTO sites(sitename,country,mat,map,notes,geometry,user_id,created_at,updated_at) VALUES(",
      "'", sitename, "', ",
      "'", country, "', ",
      mat, ", ",
      map, ", ",
...
for (s in 1:nsite) {
  ...
  if (length(id) == 0) {
    ...
    InsertString <- paste0(
      "INSERT INTO sites(sitename,country,notes,geometry,user_id,created_at,updated_at) VALUES(",
      "'", sitename, "', ",
      "'", country, "', ",
      "'", notes, "', ",
      "ST_GeomFromText('POINT(", lon, " ", lat, " ", elev, ")', 4326), ",

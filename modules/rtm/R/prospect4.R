...
##' @param Cw equivalent water thickness (EWT) in g/cm2 or cm-1
##' @param Cm dry matter content in g/cm2 (alias LMA)
##'
##' @import gsl
##' @export
...
prospect4 <- function(N,Cab,Cw,Cm){
  ...
  eps <- k[which(k==0)] # not yet sure what this is for?
...
#   t90=ta./x;
  ...
  out = data.frame(k=k,trans=trans) #temp

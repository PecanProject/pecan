...
#
#
#    --- Last updated:  03.29.2019 By Shawn P. Serbin <sserbin@bnl.gov>
####################################################################################################
...
med_agb_data <- extract.LandTrendr.AGB(site_info, "median",
  buffer = NULL, fun = "mean",
  data_dir, product_dates = NULL, file.path(work_dir, "Obs")
)
sdev_agb_data <- extract.LandTrendr.AGB(site_info, "stdv",
  buffer = NULL, fun = "mean",
  data_dir, product_dates = NULL, file.path(work_dir, "Obs")
)
...
#--------------------------------------------------------------------------------------------------#
PEcAn.logger::logger.info("**** Run SDA ****")
## Run SDA

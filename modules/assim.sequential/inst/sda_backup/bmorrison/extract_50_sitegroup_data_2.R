...
for (i in 1:5)
{
  ...
  lai <- call_MODIS(
    outdir = NULL, var = "LAI", site_info = site_info, product_dates = c("1980001", "2018365"),
...
# save(agb_data, file = '/data/bmorrison/sda/lai/50_site_run/agb_data_sites.Rdata')

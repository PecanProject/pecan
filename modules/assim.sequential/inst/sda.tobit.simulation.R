...
registerDistributions(list(ddirchmulti = list(
...
#### Storage arrays
aqq <- array(0, dim = c(2, 2, nt + 1))
Sbar.save <- aqq
Pf.save <- aqq
q.bar.save <- aqq
Pa.save <- aqq
bqq <- numeric(nt + 1)
Sbar.CI <- array(0, dim = c(3, 4, nt))
q.bar.CI <- Sbar.CI

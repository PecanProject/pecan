...
xmlfile="/fs/data3/kzarada/NEFI/US_Potato/potato.xml" #Path to, and name of, the base xml file.
...
output_path="/fs/data3/kzarada/NEFI/US_Potato/output"               #Path to the directory where all PEcAn output is put.

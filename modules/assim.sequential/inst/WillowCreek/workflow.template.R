...
if (restart == TRUE) {
  ...
  save(
    list = c("ANALYSIS", "FORECAST", "enkf.params", "ensemble.id", "ensemble.samples", "inputs", "new.params", "new.state", "run.id", "site.locs", "t", "Viz.output", "X"),
    envir = temp1,

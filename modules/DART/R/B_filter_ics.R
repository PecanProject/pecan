# Creates the filter_ics file for the DART workflow.
# fname = History file that is for the start time for the assimilation.
# t = Year of the start time for the assimilation

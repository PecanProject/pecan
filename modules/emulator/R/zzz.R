...
methods::setClass("jump", methods::representation(
  history = "numeric", count = "numeric", target = "numeric",
  clen = "numeric", arate = "numeric"
),
prototype = list(
  history = vector("numeric", 0), count = 0, target = 0.4,
...
##' @export
##'
methods::setClass("mvjump", methods::representation(
  history = "matrix", count = "numeric", target = "numeric",
  clen = "numeric", arate = "numeric", mydim = "numeric"
),
prototype = list(
  history = matrix(NA, 0, 0), count = 0, target = 0.4,

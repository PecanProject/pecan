...
```
The PDA workflow has populated you `settings` list object with couple of relevant tags, settings_PDA_round1 has these additional tags (as well as the `pecan.pdaR1_ENS_ID.xml` file that is automatically written to your workflow directory). These tags look like this:

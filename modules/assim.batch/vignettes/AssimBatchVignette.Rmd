...
We will check out the `<assim.batch>` block for MH-MCMC and the DREAMzs (recommended) algorithms. To make sure everything works fine, initially set `<iter>` to some small number like 100 though.
```
 <assim.batch>
   <method>bayesian.tools</method>
   <bt.settings>

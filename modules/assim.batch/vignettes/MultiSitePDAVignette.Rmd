...
Now let's specify the ensemble `<size>` and the ensemble `<variable>` within the `<ensemble>` tag. In the paper we give an ensemble of runs with `1000` members but you can try smaller ensembles. 

...
pda.emulator.ms <- function(multi.settings) {
  ...
  if (joint) { # joint - if begin
    ...
    ## history restart
    hbc.restart.file <- file.path(tmp.settings$outdir, paste0(
      "history.joint",

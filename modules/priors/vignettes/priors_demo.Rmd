...
```{r echo=FALSE, warning=FALSE, results='hide', message=FALSE, cache=TRUE, eval=FALSE}
...
```{r fig.width=7, fig.height=3, results='markup',eval=FALSE}

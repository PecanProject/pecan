...
## Prior Distributions
prior.Vcmax <- function(Vcmax) {
  dlnorm(Vcmax, prior.mu.Vcmax, prior.sd.Vcmax, log = TRUE)
}
prior.Jmax <- function(Jmax) {
  dlnorm(Jmax, prior.mu.Jmax, prior.sd.Jmax, log = TRUE)
}
prior.R <- function(R) {
  dlnorm(R, prior.mu.R, prior.sd.R, log = TRUE)
}
prior.Gstar <- function(Gstar) {
  dlnorm(Gstar, prior.mu.Gstar, prior.sd.Gstar, log = TRUE)
}

# prior.alpha = function(alpha)	{ dunif(alpha,0,1) }
prior.alpha <- function(alpha) {
  dlnorm(alpha, prior.mu.alpha, prior.sd.alpha, log = TRUE)
}

prior.m <- function(m) {
  dnorm(m, prior.mu.m, prior.sd.m, log = TRUE)
}
prior.g0 <- function(g0) {
  dlnorm(g0, prior.mu.g0, prior.sd.g0, log = TRUE)
}


## Jump Distributions for Metropolis Sampled Paramters
jump.Vcmax <- function(Vcmax) {
  rnorm(1, Vcmax, jumpSD.Vcmax)
}
jump.Jmax <- function(Jmax) {
  rnorm(1, Jmax, jumpSD.Jmax)
}
jump.R <- function(R) {
  rtnorm(1, R, jumpSD.R, R.lb, R.ub)
}
jump.Gstar <- function(Gstar) {
  rnorm(1, Gstar, jumpSD.Gstar)
}
jump.alpha <- function(alpha) {
  rtnorm(1, alpha, jumpSD.alpha, alpha.lb, alpha.ub)
}
jump.m <- function(m) {
  rnorm(1, m, jumpSD.m)
}
...
jump.g0 <- function(g0) {
  rtnorm(1, g0, jumpSD.g0, g0.lb, g0.ub)
}

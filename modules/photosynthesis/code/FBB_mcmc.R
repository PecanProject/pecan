...
if (sample.Vcmax) {
  Vcmax.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.Jmax) {
  Jmax.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.R) {
  R.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.Gstar) {
  Gstar.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.alpha) {
  alpha.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.m) {
  m.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.g0) {
  g0.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.tauBB) {
  tauBB.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (sample.tauF) {
  tauF.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (track.An.pred) {
  An.pred.mcmc <- matrix(NA, nrow = niter * nchains, ncol = npoints)
}
if (track.gs.pred) {
  gs.pred.mcmc <- matrix(NA, nrow = niter * nchains, ncol = npoints)
}
if (compute.DA) {
  DA.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (compute.Dgs) {
  Dgs.mcmc <- matrix(NA, nrow = niter, ncol = nchains)
}
if (compute.pA) {
  pA.mcmc <- matrix(NA, nrow = niter * nchains, ncol = npoints)
}
if (compute.pgs) {
  pgs.mcmc <- matrix(NA, nrow = niter * nchains, ncol = npoints)
}
...
for (b in 1:niter) {
  ...
  if (compute.DA) {
    DA.mcmc[b, chain] <- -2 * llik.A(my.model$An.pred, tauF)
  }

  if (compute.Dgs) {
    Dgs.mcmc[b, chain] <- -2 * llik.gs(my.model$gs.pred, tauBB)
  }

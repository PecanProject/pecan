...
HV_dist_chrono <- na.omit(
  rbind(
    cbind(disturbance_ages[HV_disturb[, 12] > 0, 12], HV_disturb[HV_disturb[, 12] > 0, 12]),
...
HH_dist_chrono <- na.omit(
  rbind(
    cbind(disturbance_ages[HH_disturb[, 12] > 0, 12], HH_disturb[HH_disturb[, 12] > 0, 12]),

...
from . datapool2pecan import datapool2pecan
import os
import os.path
...
def get_remote_data(
    ...
    if source == "datapool":
        get_datareturn_path = datapool2pecan(geofile=geofile, outdir=outdir, out_filename=raw_file_name, start=start, end=end, product=collection, credfile=credfile)

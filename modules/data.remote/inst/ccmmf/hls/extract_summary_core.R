# Weighted summary helpers for HLS polygon extraction (MSLSP-style products).
# Computes weighted mean, sd, QA mode, coverage weights, and na_frac for parcel summaries.
#
# Main inputs: data.table from raster extraction with ID, weight, layer columns.
# Main outputs: summarized data.table rows per parcel_id (or id_col).
# How to run: sourced by tilewise_mslsp_implementation.R; not a standalone CLI.
# Workflow: shared by MSLSP tile extraction and combine steps.

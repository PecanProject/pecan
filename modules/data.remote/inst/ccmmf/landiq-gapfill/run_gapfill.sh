...
CCMMF_LANDIQ_GAPFILL_PRODUCT="${CCMMF_LANDIQ_GAPFILL_PRODUCT:-$CCMMF_ROOT/LandIQ-harmonized-v4.1.2}"
...
export CCMMF_ROOT LANDIQ_GAPFILL_ROOT CCMMF_LANDIQ_V4 CDL_DIR CDL_OUT_DIR
export CCMMF_LANDIQ_GAPFILL_PRODUCT LANDIQ_GAPFILL_FULL_GAP_YEARS

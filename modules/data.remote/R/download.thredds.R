...
##' results <- PEcAn.data.remote::download.thredds.data(outdir = NULL, site_info, dates = c("19950201", "19961215"), varid = "LAI",dir_url = "https://www.ncei.noaa.gov/thredds/catalog/cdr/lai/files", data_url = "https://www.ncei.noaa.gov/thredds/dodsC/cdr/lai/files",run_parallel = FALSE)
##'            
##' @export
##' @author Bailey Morrison
##'
download.thredds.data <- function(outdir = NULL, 
                                  site_info, 
                                  dates, 
                                  varid,
                                  dir_url, 

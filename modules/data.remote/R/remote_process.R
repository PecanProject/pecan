...
remote_process <- function(settings) {
  ...
  PEcAn.logger::severeifnot(
    "Check if siteid is of numeric type and is not NULL",
    is.numeric(siteid)
  )
  PEcAn.logger::severeifnot(
    "Check if outdir is of character type and is not NULL",
    is.character(outdir)
  )
  PEcAn.logger::severeifnot(
    "Check if source is of character type and is not NULL",
    is.character(source)
  )
  ...
  if (!is.null(projection)) {
    PEcAn.logger::severeifnot(
      "projection should be of character type",
      is.character(projection)
    )
  }
  if (!is.null(algorithm)) {
    PEcAn.logger::severeifnot(
      "algorithm should be of character type",
      is.character(algorithm)
    )
  }
  if (!is.null(credfile)) {
    PEcAn.logger::severeifnot(
      "credfile should be of character type",
  ...
  if (!is.null(out_process_data)) {
    PEcAn.logger::severeifnot(
      "out_process_data should be of character type",

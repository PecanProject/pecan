...
##' @export
##' @param settings PEcAn settings list containing remotedata tags: raw_mimetype, raw_formatname, geofile, source, collection, scale, projection, qc, algorithm, credfile, pro_mimetype, pro_formatname, out_get_data, out_process_data
##' @examples
##' \dontrun{

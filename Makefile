...
$(call depends,modules/allometry): | .install/base/logger"
$(call depends,modules/assim.batch): | .install/base/utils .install/base/logger .install/base/db .install/modules/meta.analysis .install/base/logger .install/base/remote .install/base/settings
$(call depends,modules/assim.sequential): | .install/base/logger .install/base/remote
...
$(call depends,modules/data.land): | .install/base/db .install/base/utils .install/base/logger .install/base/remote
$(call depends,modules/data.mining): | .install/base/logger
$(call depends,modules/data.remote): | .install/base/logger .install/base/remote
...
$(call depends,models/ed.Rcheck/PEcAn.ED2): | .install/base/utils
$(call depends,models/ed): | .install/base/utils .install/base/logger .install/base/remote .install/base/settings
...
$(call depends,models/linkages): | .install/base/utils .install/base/logger .install/base/remote
$(call depends,models/lpjguess): | .install/base/utils .install/base/logger .install/base/remote
$(call depends,models/maat): | .install/base/logger .install/base/remote .install/base/settings .install/base/utils

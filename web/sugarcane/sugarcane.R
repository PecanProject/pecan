...
InputForWeach <- function(lat, lon, year1, year2) {
  ...
  avgTemp <- NCEP.gather(
    variable = c("air.2m"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
  ...
  solarR <- NCEP.gather(
    variable = c("dswrf.sfc"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
  ...
  ## T Maximum Data
  Tmax <- NCEP.gather(
    variable = c("tmax.2m"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
  ...
  ## T Minimum Data
  Tmin <- NCEP.gather(
    variable = c("tmin.2m"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
  ...
  Vwind <- NCEP.gather(
    variable = c("vwnd.10m"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
  ...
  Uwind <- NCEP.gather(
    variable = c("uwnd.10m"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
  ...
  Rain <- NCEP.gather(
    variable = c("prate.sfc"), level = "gaussian", months.minmax = c(1, 12), years.minmax = c(year1, year2), lat.southnorth = c(lat, lat), lon.westeast = c(lon, lon), reanalysis2 = TRUE,
    return.units = FALSE, status.bar = FALSE
  )
